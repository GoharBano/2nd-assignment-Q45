...
let f =('would you like to learn some TypeScrips today ?')
let g =(c+f)
console.log(g)
...
let nam = ["Noman", "Kamran", "Basil", "Mujtaba"];
for (let i = 0; i < 4; i++) {
    console.log(nam[i]);
}
...
let nms = ["Uzair", "Danish", "Sheroz", "Basil"];
...
let nm = ["Noman", "Kamran", "Basil", "Mujtaba"];
for (let i = 0; i < 4; i++) {
